...
namespace GIS
{
    ...
    {
        [MenuItem("GameObject/GIS/Turn Object Into Inventory Item")]
        private static void TurnObjectIntoInventoryItem()
        {
        ...
        [MenuItem("GameObject/GIS/Turn Object Into Inventory Item", true)]
        [MenuItem("GameObject/GIS/Add Inventory", true)]
        private static bool ValidateTurnObjectIntoInventoryItem()
        {
            return Selection.activeGameObject != null;
        }

        [MenuItem("GameObject/GIS/Add Inventory Item", false)]
        ...
        [MenuItem("GameObject/GIS/Add Inventory")]
        private static void AddInventory()
        {
            GameObject obj = Selection.activeGameObject;
            if (obj != null)
            {
                if (!obj.TryGetComponent<Inventory>(out var _))
                {
    ...
    class InventoryItemEditorWindow : EditorWindow
    {
        ...
        private void OnGUI()
        {
            ...
            if (GUILayout.Button("Save"))
            {
                ...
                itemObject.GetComponent<CollectableItem>().SetItem(item);
